        ...
        <article>
                ...
                <?php } else { ?>
                    ...
                    <ul class="menu_sanpham">
                        ...
                        <?php foreach($boloc_giasp as $gia): ?>
                            ...
                            <?php if($gia['gia0510']){ ?>
                            <li><a href="
                                        index.php?MIN=5000000&MAX=10000000&
                                        <?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?>
                                        <?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?>
                                        <?php if($card != ""){ echo 'card='.$card.'&'; } ?>
                                        <?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?>
                            ...
                            <?php if($gia['gia1020']){ ?>
                            <li><a href="
                                        index.php?MIN=10000000&MAX=20000000&
                                        <?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?>
                                        <?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?>
                                        <?php if($card != ""){ echo 'card='.$card.'&'; } ?>
                                        <?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?>
                            ...
                            <?php if($gia['gia2030']){ ?>
                            <li><a href="
                                        index.php?MIN=20000000&MAX=30000000&
                                        <?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?>
                                        <?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?>
                                        <?php if($card != ""){ echo 'card='.$card.'&'; } ?>
                                        <?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?>
            ...
            <div class="sapxep">
                ...
                <select name="sapxep" id="sapxepSelect" onchange="sapxepTheo()">
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=1&">Chọn...</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=2&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Mới nhất</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=3&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Cũ nhất</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=4&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Giá tăng dần</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=5&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Giá giảm dần</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=6&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Tên từ A-Z</option>
                    <option value="http://localhost/LaptopWorld/index.php?sapxep=7&<?php if($brand != ""){ echo 'brand='.$brand.'&'; } ?><?php if($MIN != ""){ echo 'MIN='.$MIN.'&'; } ?><?php if($MAX != ""){ echo 'MAX='.$MAX.'&'; } ?><?php if($cpu != ""){ echo 'cpu='.$cpu.'&'; } ?><?php if($card != ""){ echo 'card='.$card.'&'; } ?><?php if($ram != ""){ echo 'ram='.$ram.'&'; } ?><?php if($ssd != ""){ echo 'ssd='.$ssd.'&'; } ?><?php if($keyword != ""){ echo 'keyword='.$keyword.'&'; } ?>">Nhiều lượt xem nhất</option>
                </select>
            </div>
            <!-- end lọc sp -->
