                        ...
                        <tr onmouseover="tinhtongtien()">
                            ...
                            <td class="border-1" style="width: 750px;">
                                <div class="img_cart" style="display: flex; align-items: center;">
                                    ...
                                    <div class="text_cart" style="margin-left: 20px;"><a href="#"><?php echo $a['tensp'] ?></a>
                                        <div class="baohanh">
                                            Bảo hành 12 tháng
                                        </div>
                                    </div>
                            ...
                            <td id="gia-<?php echo $a['id_ctgiohang'] ?>" class="border-1"><?php echo $a['giasp'] ?></td>
                            <!-- tăng giảm số lượng sản phẩm -->
                            <td class="border-1">
                                <div class="number" style="display: flex;">
                                    <button type="button" class="btn btn-link px-2" onclick="decrement('<?php echo $a['id_ctgiohang'] ?>')">
                                    <i class="fas fa-minus"></i>
                                    </button>
                                    <input id="soluongsp-<?php echo $a['id_ctgiohang'] ?>" style="width: 50px;" id="form1" min="1" name="quantity_<?php echo $i ?>" value="<?php echo $a['soluong'] ?>" type="number" class="form-control form-control-sm" />
                                    <button type="button" class="btn btn-link px-2" onclick="increment('<?php echo $a['id_ctgiohang'] ?>')">
                            ...
                            <!-- xóa sản phẩm -->
                            <td>
                                <a href="index.php?act=xoasp&id_ctgiohang=<?php echo $a['id_ctgiohang'] ?>"><img style="margin-left: 10px;" src="./img/icon_cart_del.png"></a>
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="border-1" colspan="4">
                                <!-- tổng tiền vn -->
                                <h3 style="font-weight: bold; font-size: 16px;">Tổng cộng : <input id="tongcong" name="tongtien_vn" type="text" value="" disabled style="outline: none; border: none; background: #fff; width:auto;"></h3>
                                <div style="color: red; font-weight: bold;" class="thanhtoan">Thanh toán: <input id="thanhtoan" type="text" value="" disabled style="outline: none; border: none; background: #fff; width:auto;"></div>
                            </td>
                        </tr>
                    </tfoot>
            ...
            <div class="thanhtoan" style="width: 1200px; margin: auto; display: grid; grid-template-columns: 750px 450px;">
                <div class="thongtin_kh" style="border: 1px solid #cccccc;">
                    ...
                    <form action="" style="padding: 15px 10px;">
                        ...
                        <!-- tên người nhận -->
                        <div class="name">
                            Họ tên :<input name="nn_name" style="margin:4px 50px; width: 400px;" type="text">
                        </div>
                        <!-- điện thoại  -->
                        <div class="name">
                            Điện thoại :<input name="nn_tel" style="margin:4px 25px; width: 400px;" type="text">
                        </div>
                        <!-- địa chỉ  -->
                        <div class="name">
                        ...
                        <!-- email  -->
                        <div class="name">
                            Email :<input name="nn_email" style="margin:4px 59px; width: 400px;" type="text">
                        </div>
                ...
                <div class="phuongthuc_tt" style="border: 1px solid #cccccc; margin-left: 10px;">
                    ...
                    <div class="ghi_chu" style="padding: 10px; border-bottom: 1px solid #cccccc;">
                        <textarea name="ghichu" id="" cols="30" rows="10" style="width: 100%; height: 100px;"></textarea>
                    </div>
                    <div class="text_ghichu">
                ...
                <div class="sumnit" style="width: 1200px; margin: auto; padding: 20px 0;">
                    <button type="submit" name="guidonhang" class="btn btn-warning" style="margin-left: 89.8%;">Gửi đơn hàng</button>
                </div>
            </div>
        </form>
        <!-- end thanh toán -->
